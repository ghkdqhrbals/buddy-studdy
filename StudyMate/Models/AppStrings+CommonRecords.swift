...
extension AppStrings {
    ...
    var voiceRecordTutorQuestion: String { commonRecordText("버디 질문", "Buddy’s question", "バディの質問") }
    var voiceRecordLearnerQuestion: String { commonRecordText("학습자 질문", "Learner's question", "学習者の質問") }
    var voiceRecordTutorAnswer: String { commonRecordText("버디 답변", "Buddy’s answer", "バディの回答") }
