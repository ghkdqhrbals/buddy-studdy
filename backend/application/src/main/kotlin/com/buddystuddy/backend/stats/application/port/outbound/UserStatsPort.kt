...
interface UserStatsPort {
    ...
    fun supportsIncrementalRefresh(): Boolean
    fun markDirty(userId: Long, statDate: LocalDate, topicKey: String, difficultyLevel: Int, now: Instant)
    fun refreshDirty(now: Instant, limit: Int): Int
