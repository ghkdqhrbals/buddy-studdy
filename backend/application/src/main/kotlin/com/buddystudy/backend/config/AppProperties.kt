...
data class BuddyStudyProperties(
    ...
    data class Streams(
        ...
        var legacyDrainEnabled: Boolean = true,
        var legacyDomainKey: String = "buddystudy-events-v1",
        var legacyQuestionGenerationKey: String = "buddystudy-question-generation-v1",
        var legacyQuestionGeneratedKey: String = "buddystudy-question-generated-v1",
        var legacyContentTranslationKey: String = "buddystudy-content-translation-v1",
        var legacyPushKey: String = "buddystudy-push-v1",
        var legacyMaxLen: Long = 1_000,
