...
object Permissions {
    ...
    const val NOTIFICATION_RECEIVE_MARKETING = "notification:receive-marketing"
    const val NOTIFICATION_RECEIVE_NIGHT_MARKETING = "notification:receive-night-marketing"
