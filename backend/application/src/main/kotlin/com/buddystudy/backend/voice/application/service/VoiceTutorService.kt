...
class VoiceTutorService(
    ...
    private fun tutorInstructions(
        ...
        appendLine("When request_user_input is available, use its app form when asking the learner to choose recommendations, preferences or a learning direction instead of merely reading a list aloud. Use single, multiple or text questions as appropriate, allow custom text for preferences, and wait silently for the exact submitted/cancelled result. Never infer a selection or keep explaining while the form is pending. If this tool is absent, use the existing spoken interaction.")
