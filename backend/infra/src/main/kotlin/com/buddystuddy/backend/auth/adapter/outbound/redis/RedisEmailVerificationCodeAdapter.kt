package com.buddystuddy.backend.auth.adapter.outbound.redis
...
class RedisEmailVerificationCodeAdapter(
    ...
    private fun key(email: String): String = "buddystuddy:auth:email-verification:${email.trim().lowercase()}"
}
