...
class APIErrorCode(str, Enum):
    ...
    AUTH_EMAIL_VERIFICATION_QUOTA_EXCEEDED = "AUTH_EMAIL_VERIFICATION_QUOTA_EXCEEDED"
...
DETAIL_CODE_MAP: dict[str, APIErrorCode] = {
    ...
    "Email verification email quota exceeded.": APIErrorCode.AUTH_EMAIL_VERIFICATION_QUOTA_EXCEEDED,
