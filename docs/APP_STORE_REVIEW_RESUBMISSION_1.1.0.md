...
- [ ] Check `app-store/review-assets/membership-review-2026-08-26-1242x2688.png` against the replacement build's monthly-only membership UI: no annual choice, the correct localized price, Tier 2 `300` or Tier 3 `1,000` benefit, the paid ad-free public-feed benefit, and the purchase disclosure are visible. Replace it if the candidate differs instead of assuming the fixture still matches.
