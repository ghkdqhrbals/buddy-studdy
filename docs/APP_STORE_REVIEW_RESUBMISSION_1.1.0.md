...
- [ ] Check `app-store/review-assets/membership-review-2026-09-13-1242x2688.png` against the replacement build's monthly-only membership UI: no annual choice, the correct localized price, Plus `300` or Pro `1,000` benefit, the paid ad-free public-feed benefit, and the purchase disclosure are visible. Replace it if the candidate differs instead of assuming the fixture still matches.
