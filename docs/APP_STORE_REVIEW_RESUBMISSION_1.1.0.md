...
AWS Seoul hosts the API, data, and operator-managed LibreTranslate; Cloudflare provides DNS/TLS/proxy/security; OpenAI provides questions, grading, feedback, suggestions, and translation fallback; Apple provides sign-in, subscriptions, and APNs; RevenueCat provides products, purchase/restore, Customer Center, and subscription sync; Google provides sign-in, registration email verification, Firebase Analytics/Remote Config, UMP consent, and non-personalized AdMob native ads; Sentry provides masked diagnostics.
...
Plus is a one-month auto-renewable subscription with 300 AI questions per monthly quota period; Pro has 1,000. Both paid tiers remove native ads from the public feed. One generated question uses one allowance; study/topic creation does not. Path: Home > Profile > Membership & Billing > Manage membership > Plus/Pro > Get Plus/Pro or Switch to Plus/Pro. Each offer shows title, localized price, one-month duration, allowance, ad-free benefit, renewal disclosure, Terms, Privacy, Restore, and purchase/change control. It opens Apple's purchase sheet; the video cancels before purchase. Manage Subscription appears only for active subscribers. Apple handles payments, renewals, cancellations, and refunds.
...
6. From Home, tap the top-left Profile button, then open Membership & Billing > Manage membership. With the free review account, show both monthly products, localized prices, Plus `300` and Pro `1,000` question benefits, one-month duration, auto-renewal disclosure, Terms, Privacy Policy, Restore Purchases, and the purchase/change control. Tap Get Plus/Pro or Switch to Plus/Pro so Apple's purchase confirmation sheet is visibly presented, then cancel it before purchase. Use TestFlight/Sandbox without exposing credentials. Manage Subscription appears only for an account with an active subscription.
...
- [ ] Subscription rows and the pre-purchase screen show price, one-month duration, exact question allowance, the paid ad-free public-feed benefit, auto-renewal terms, legal links, restore, and purchase/change controls; Manage Subscription is checked separately only with an active subscription.
- [ ] Check `app-store/review-assets/membership-review-2026-08-26-1242x2688.png` against the replacement build's monthly-only membership UI: no annual choice, the correct localized price, Plus `300` or Pro `1,000` benefit, the paid ad-free public-feed benefit, and the purchase disclosure are visible. Replace it if the candidate differs instead of assuming the fixture still matches.
...
- [ ] The 2026-08-25 Privacy Policy and Terms URLs open in English and match current shipped behavior, including UMP, non-personalized AdMob, ATT/IDFA non-use, and paid ad removal.
...
- [ ] The video visibly opens Apple's purchase confirmation sheet from Get Plus/Pro or Switch to Plus/Pro and then cancels before purchase.
