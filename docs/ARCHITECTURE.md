...
- `Services/SettingsStore.swift`
  ...
  - Stores settings, API keys, draft state, logs, CloudKit sync metadata, and exposes an in-memory record cache for the current session.
