...
final class BillingLocalizationTests: XCTestCase {
    func testMembershipAndBillingLabelsAreLocalizedInJapanese() {
        ...
        XCTAssertEqual(AppStrings(language: .korean).membershipTierName("TIER1"), "Tier 1")
        XCTAssertEqual(AppStrings(language: .korean).membershipTierName("TIER2"), "Tier 2")
        XCTAssertEqual(AppStrings(language: .korean).membershipTierName("TIER3"), "Tier 3")
