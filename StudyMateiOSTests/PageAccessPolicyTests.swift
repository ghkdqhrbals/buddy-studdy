...
final class BillingLocalizationTests: XCTestCase {
    func testMembershipAndBillingLabelsAreLocalizedInJapanese() {
        ...
        XCTAssertEqual(strings.membershipTierName("TIER1"), "Free")
        XCTAssertEqual(strings.membershipTierName("TIER2"), "Plus")
        XCTAssertEqual(AppStrings(language: .korean).membershipTierName("TIER1"), "Free")
        XCTAssertEqual(AppStrings(language: .korean).membershipTierName("TIER2"), "Plus")
        XCTAssertEqual(AppStrings(language: .korean).membershipTierName("TIER3"), "Pro")
        XCTAssertEqual(AppStrings(language: .english).membershipTierName("TIER1"), "Free")
...
final class NativeAdvertisementPolicyTests: XCTestCase {
    ...
    func testNativeAdRowLayoutUsesCompactMinimumAndExpandsForIntrinsicContent() {
        ...
        XCTAssertEqual(NativeAdvertisementRowLayoutPolicy.mediaCornerRadius, 9)
        XCTAssertEqual(NativeAdvertisementRowLayoutPolicy.sectionSpacing, 10)
        XCTAssertEqual(NativeAdvertisementRowLayoutPolicy.mainContentSpacing, 10)
        ...
        XCTAssertEqual(NativeAdvertisementRowLayoutPolicy.textStackSpacing, 6)
        XCTAssertEqual(NativeAdvertisementRowLayoutPolicy.metadataSpacing, 7)
        XCTAssertEqual(NativeAdvertisementRowLayoutPolicy.callToActionMinimumHeight, 28)
